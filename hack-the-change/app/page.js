    ...
    <main className="bg-gray-100 flex flex-col min-h-screen">
      ...
      <div className="flex flex-row m-2">
        <NavButton className="hover:pr-32 bg-gradient-to-r from-lime-200 to-green-200" clickFunc={() => {
          ...
          <svg className="p-3 ml-2" fill="#16a34a" xmlns="http://www.w3.org/2000/svg" height="4em" viewBox="0 0 320 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/></svg>
        </NavButton>
        <NavButton className="hover:pl-32 flex justify-end bg-gradient-to-r from-green-200 to-lime-200" clickFunc={() => {
          changeScreen(true);
        }}>
